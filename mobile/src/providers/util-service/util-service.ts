...
export class UtilServiceProvider {
  ...
  // this method will sort according to time period
  ...
  // if time in tp key
    if(a.tp)
    {
      ...
      // if tp is in 2016 format
       ...
       // if in format of May_2017-Dec_2017
       else
       {
      ...
      else
      {
       ...
       let monthEnd1=a.axis.split("_")[0].split("-")[1].trim()
        let monthEnd2 = b.axis.split("_")[0].split("-")[1].trim()
